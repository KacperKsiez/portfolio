...
function _typeof(a){"@babel/helpers - typeof";return _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(a){return typeof a}:function(a){return a&&"function"==typeof Symbol&&a.constructor===Symbol&&a!==Symbol.prototype?"symbol":typeof a},_typeof(a)}function _classCallCheck(a,b){if(!(a instanceof b))throw new TypeError("Cannot call a class as a function")}function _defineProperties(a,b){for(var c,d=0;d<b.length;d++)c=b[d],c.enumerable=c.enumerable||!1,c.configurable=!0,"value"in c&&(c.writable=!0),Object.defineProperty(a,_toPropertyKey(c.key),c)}function _createClass(a,b,c){return b&&_defineProperties(a.prototype,b),c&&_defineProperties(a,c),Object.defineProperty(a,"prototype",{writable:!1}),a}function _toPropertyKey(a){var b=_toPrimitive(a,"string");return"symbol"===_typeof(b)?b:b+""}function _toPrimitive(a,b){if("object"!==_typeof(a)||null===a)return a;var c=a[Symbol.toPrimitive];if(c!==void 0){var d=c.call(a,b||"default");if("object"!==_typeof(d))return d;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===b?String:Number)(a)}var NavSwitcher=/*#__PURE__*/function(){function a(){_classCallCheck(this,a),this.headerDiv=document.querySelector(".header"),this.sectionTopDiv=document.querySelector(".overlay")}return _createClass(a,[{key:"init",value:function init(){this.switchClassNameOnScroll(),this.hideOnHrefClick()}},{key:"switchClassNameOnScroll",value:function switchClassNameOnScroll(){var a=this,b=new IntersectionObserver(function(b){var c=b[0];c.isIntersecting?a.headerDiv.classList.remove("header--scrolled"):a.headerDiv.classList.add("header--scrolled")},{threshold:.8});b.observe(this.sectionTopDiv)}},{key:"hideOnHrefClick",value:function hideOnHrefClick(){var a=document.querySelector("#menu-switch"),b=document.querySelectorAll(".header__list-item");b.forEach(function(b){b.addEventListener("click",function(){a&&a.checked&&(a.checked=!1)})})}}]),a}();
// EXTERNAL MODULE: ./node_modules/particles.js/particles.js
var particles = __webpack_require__(388);
...
;// CONCATENATED MODULE: ./src/scripts/movingOverlayImage.ts
function movingOverlayImage_typeof(a){"@babel/helpers - typeof";return movingOverlayImage_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(a){return typeof a}:function(a){return a&&"function"==typeof Symbol&&a.constructor===Symbol&&a!==Symbol.prototype?"symbol":typeof a},movingOverlayImage_typeof(a)}function movingOverlayImage_classCallCheck(a,b){if(!(a instanceof b))throw new TypeError("Cannot call a class as a function")}function movingOverlayImage_defineProperties(a,b){for(var c,d=0;d<b.length;d++)c=b[d],c.enumerable=c.enumerable||!1,c.configurable=!0,"value"in c&&(c.writable=!0),Object.defineProperty(a,movingOverlayImage_toPropertyKey(c.key),c)}function movingOverlayImage_createClass(a,b,c){return b&&movingOverlayImage_defineProperties(a.prototype,b),c&&movingOverlayImage_defineProperties(a,c),Object.defineProperty(a,"prototype",{writable:!1}),a}function movingOverlayImage_toPropertyKey(a){var b=movingOverlayImage_toPrimitive(a,"string");return"symbol"===movingOverlayImage_typeof(b)?b:b+""}function movingOverlayImage_toPrimitive(a,b){if("object"!==movingOverlayImage_typeof(a)||null===a)return a;var c=a[Symbol.toPrimitive];if(c!==void 0){var d=c.call(a,b||"default");if("object"!==movingOverlayImage_typeof(d))return d;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===b?String:Number)(a)}var MovingOverlayImage=/*#__PURE__*/function(){function a(){movingOverlayImage_classCallCheck(this,a)}return movingOverlayImage_createClass(a,[{key:"init",value:function init(){gsapWithCSS.registerPlugin(ScrollTrigger_ScrollTrigger),gsapWithCSS.to(".overlay__img",{x:"45%",scrollTrigger:{scrub:!0,start:0}}),gsapWithCSS.to(".overlay__content",{x:"-25%",scrollTrigger:{scrub:!0,start:0}})}},{key:"rest",value:function rest(){var a=document.querySelectorAll(".card");// Animuj wszystkie karty z efektem stagger
gsapWithCSS.fromTo(a,{x:"-100%"},// Początkowa pozycja poza ekranem z lewej strony
{x:"0%",duration:1,ease:"power2.out",stagger:.2,scrollTrigger:{trigger:a[0],start:"top center",end:"bottom center",scrub:!0,toggleActions:"play none none none"// Wyzwalaj animację tylko przy przewijaniu w dół
}})}}]),a}();
;// CONCATENATED MODULE: ./src/scripts/toggleGoUpArrowOnScroll.ts
function toggleGoUpArrowOnScroll_typeof(a){"@babel/helpers - typeof";return toggleGoUpArrowOnScroll_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(a){return typeof a}:function(a){return a&&"function"==typeof Symbol&&a.constructor===Symbol&&a!==Symbol.prototype?"symbol":typeof a},toggleGoUpArrowOnScroll_typeof(a)}function toggleGoUpArrowOnScroll_classCallCheck(a,b){if(!(a instanceof b))throw new TypeError("Cannot call a class as a function")}function toggleGoUpArrowOnScroll_defineProperties(a,b){for(var c,d=0;d<b.length;d++)c=b[d],c.enumerable=c.enumerable||!1,c.configurable=!0,"value"in c&&(c.writable=!0),Object.defineProperty(a,toggleGoUpArrowOnScroll_toPropertyKey(c.key),c)}function toggleGoUpArrowOnScroll_createClass(a,b,c){return b&&toggleGoUpArrowOnScroll_defineProperties(a.prototype,b),c&&toggleGoUpArrowOnScroll_defineProperties(a,c),Object.defineProperty(a,"prototype",{writable:!1}),a}function toggleGoUpArrowOnScroll_toPropertyKey(a){var b=toggleGoUpArrowOnScroll_toPrimitive(a,"string");return"symbol"===toggleGoUpArrowOnScroll_typeof(b)?b:b+""}function toggleGoUpArrowOnScroll_toPrimitive(a,b){if("object"!==toggleGoUpArrowOnScroll_typeof(a)||null===a)return a;var c=a[Symbol.toPrimitive];if(c!==void 0){var d=c.call(a,b||"default");if("object"!==toggleGoUpArrowOnScroll_typeof(d))return d;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===b?String:Number)(a)}var ToggleGoUpArrowOnScroll=/*#__PURE__*/function(){function a(){toggleGoUpArrowOnScroll_classCallCheck(this,a),this.toggleDiv=document.querySelector(".overlay"),this.arrowDiv=document.querySelector(".go-up"),this.arrowDiv.addEventListener("click",function(){window.scrollTo(0,0)})}return toggleGoUpArrowOnScroll_createClass(a,[{key:"init",value:function init(){var a=this,b=new IntersectionObserver(function(b){var c=b[0];c.isIntersecting?a.arrowDiv.classList.remove("go-up--active"):a.arrowDiv.classList.add("go-up--active")});b.observe(this.toggleDiv)}}]),a}();
;// CONCATENATED MODULE: ./src/index.js
// eslint-disable-next-line no-undef
new NavSwitcher().init(),new MovingOverlayImage().init(),new ToggleGoUpArrowOnScroll().init(),particlesJS("overlay",{particles:{number:{value:80,density:{enable:!0,value_area:800}},color:{value:"#ffffff"},shape:{type:"circle",stroke:{width:0,color:"#000000"},polygon:{nb_sides:5}},opacity:{value:.1,random:!1,anim:{enable:!1,speed:1,opacity_min:.1,sync:!1}},size:{value:5,random:!0,anim:{enable:!1,speed:40,size_min:.1,sync:!1}},line_linked:{enable:!0,distance:150,color:"#ffffff",opacity:.1,width:1},move:{enable:!0,speed:6,direction:"none",random:!1,straight:!1,out_mode:"out",bounce:!1,attract:{enable:!1,rotateX:600,rotateY:1200}}},interactivity:{detect_on:"canvas",events:{onhover:{enable:!0,mode:"repulse"},onclick:{enable:!1,mode:"push"},resize:!0},modes:{grab:{distance:400,line_linked:{opacity:1}},bubble:{distance:400,size:40,duration:2,opacity:8,speed:3},repulse:{distance:100,duration:.4},push:{particles_nb:4},remove:{particles_nb:2}}},retina_detect:!0});
})();
